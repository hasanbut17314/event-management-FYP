...
if (isset($_POST['confirm_booking_btn'])) {
    ...
    else
    {
        ...
        $insert_query = "INSERT INTO booking (name, email, phone, address, date, no_of_guest, event_type, payment_method, comments) VALUES ('$name', $email', $phone', '$address', '$date', '$no_of_guest', '$event_type', '$payment_method', '$comments')";
